...
export const mainDrawer = ({ navigation, route }) => {
	...
	return (
		<Drawer.Navigator drawerType={'slide'}>
			{user.type == 'driver' ? (
				<Drawer.Screen name="My Ride" component={DriversScreen} initialParams={user} />
			) : (
				<Drawer.Screen name="Schedule Rides" component={RidersScreen} initialParams={user} />
			)}
			<Drawer.Screen name="Credits" component={Credits} initialParams={user} />
			<Drawer.Screen name="Q&A" component={QA} initialParams={user} />
			<Drawer.Screen name="Contact Us" component={ContactUs} initialParams={user} />
		</Drawer.Navigator>
	);
};
